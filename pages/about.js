...
const About = () => {
	const teachersArr = [
		{ name: "Brad Travesty", img: brad, link: "" },
		{ name: "Ania Kubów", img: ania },
		{ name: "Sonny Sangha", img: sonny },
		{ name: "Dev Ed", img: deved },
	];

	const contentArr = [
		{ name: "Youtube", img: youtube },
		{ name: "Udemy", img: udemy },
		{ name: "StackOverflow", img: stack },

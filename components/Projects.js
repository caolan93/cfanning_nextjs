	...
	return (
		<motion.div
			...
			<div className='flex flex-col mx-auto'>
				<div className='m-2'>
					<a href='https://airbnb-nextjs-clone.vercel.app/' target='_blank'>
						<ProjectCard
							title='Airbnb Clone'
				...
				<div className='m-2'>
					<a href='https://hulu-clone-sigma-seven.vercel.app/' target='_blank'>
						<ProjectCard
			...
			<div className='flex flex-col mx-auto'>
				<div className='m-2'>
					<a href='https://proshop-mernapp.herokuapp.com/' target='_blank'>
						<ProjectCard
							title='Proshop'
							image={proshoptn}
				...
				<div className='m-2'>
					<a
						href="link='https://proshop-mernapp.herokuapp.com/"
						target='_blank'>
						<ProjectCard
